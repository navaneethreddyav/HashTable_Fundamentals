...
public class Q2 {
    ...
    public static void main(String[] args) {
        Q2 sale = new Q2();
        sale.addProduct("IPHONE15_256GB", 2);

        System.out.println(sale.purchaseItem("IPHONE15_256GB", 12345));
        System.out.println(sale.purchaseItem("IPHONE15_256GB", 67890));
        System.out.println(sale.purchaseItem("IPHONE15_256GB", 99999));
        System.out.println(sale.purchaseItem("IPHONE15_256GB", 88888));
    }
}